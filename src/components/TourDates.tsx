...
import { Link } from "react-router-dom"; // Updated import from next/link to react-router-dom
...
const TourDates = () => {
  ...
  return (
    <section id="tour" className="relative py-20 md:py-32 bg-gradient-to-b from-slate-50 to-white">
      <div className="container px-4 max-w-6xl mx-auto">
        <div className="text-center mb-12 opacity-0 animate-fade-in">
          ...
          <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-fuchsia-600 text-transparent bg-clip-text">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="flex-shrink-0">
                        <span className={cn("text-xs font-medium px-2 py-1 rounded-full", 
                          show.status === "Sold Out" ? "bg-destructive/10 text-destructive" : 
                          show.status === "Few Left" ? "bg-amber-100 text-amber-700" : 
                    ...
                    <Link 
                      ...
                      className={cn(
                        ...
                        show.status === "Sold Out" 
                          ...
                          : "bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 group-hover:translate-y-0"
                      )}
            ...
            {upcomingVisibleCount < upcomingShows.length && (
              <div className="text-center mt-8">
                <Button 
                  ...
                  variant="outline"
                  className="bg-white hover:bg-primary/5 border-indigo-200 text-indigo-700 hover:text-indigo-800 hover:border-indigo-300"
                >
                  Load More Shows
                </Button>
              </div>
          ...
          <TabsContent value="past" className="space-y-8 mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {pastShows.slice(0, pastVisibleCount).map(show => (
                <Card key={show.id} className="overflow-hidden hover:shadow-md transition-all bg-gradient-to-br from-white to-slate-50">
                  <CardContent className="p-6">
                    ...
                    <Link 
                      to={show.videoLink}
                      className="w-full inline-flex items-center justify-center rounded-md py-2 px-4 text-sm font-medium bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 hover:from-gray-200 hover:to-gray-300 transition-all border border-gray-200"
                    >
            ...
            {pastVisibleCount < pastShows.length && (
              <div className="text-center mt-8">
                <Button 
                  ...
                  variant="outline"
                  className="bg-white hover:bg-primary/5 border-gray-200 text-gray-600 hover:text-gray-800 hover:border-gray-300"
                >
